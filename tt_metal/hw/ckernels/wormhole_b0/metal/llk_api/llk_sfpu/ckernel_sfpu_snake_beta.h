...
// (≈1.03e5) before float_to_int16 saturation.
...
#pragma GCC unroll 8
    for (int d = 0; d < ITERATIONS; d++) {
        ...
        // reserved for the reciprocal estimate so float_to_int16 is used instead.
        sfpi::vFloat ax_over_pi = ax * one_over_pi;
        sfpi::vInt k = sfpi::float_to_int16(ax_over_pi, sfpi::RoundMode::NearestEven);
        sfpi::vFloat k_f = sfpi::int32_to_float(k, sfpi::RoundMode::NearestEven);
